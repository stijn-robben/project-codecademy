...
public class EnrollmentScene extends InputChecks {
    database.EnrollmentData enrollmentData = new database.EnrollmentData();

    public void enrollmentScene(Stage stage) {
        ...
        RadioButton rb2 = new RadioButton("Read courses of a student");
        rb2.setToggleGroup(radioGroup);
        RadioButton rb3 = new RadioButton("Read students in course");
        ...
        radioGroup.selectedToggleProperty().addListener(new ChangeListener<Toggle>() {
            public void changed(ObservableValue<? extends Toggle> ob, Toggle o, Toggle n) {
                ...
                if (rb != null) {
                    ...
                    if (s.equals("Read courses of a student")) {
                    ...
                    if (s.equals("Read students in course")) {
                        setManagedAndVisableTrue(value0);
        ...
        submit.setOnAction((event) -> {
            ...
            if (s.equals("Read courses of a student")) {
                try {
                    output.setText(enrollmentData.readCoursesOfStudent(value1.getText()));
                } catch (Exception e) {
                    output.setText(e + "");
                }
            }
            ...
            if (s.equals("Read students in course")) {
                try {
                    output.setText(enrollmentData.readStudentsInCourse(value0.getText()));
                } catch (Exception e) {
            ...
            if (s.equals("Create")) {
                try {
                    output.setText(enrollmentData.createEnrollment(value0.getText(), value1.getText()));
                } catch (Exception e) {
                    output.setText(
                            "Something went wrong... Check if the student is already enrolled and if the course/student exist.");
                }
            }

            if (s.equals("Delete")) {
                try {
                    output.setText(enrollmentData.deleteEnrollment(value0.getText(), value1.getText()));
                } catch (Exception e) {
                    output.setText("Something went wrong... Check if the student is enrollment exists.");
                }
            }
